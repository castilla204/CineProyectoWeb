...
namespace Data.Migrations
{
    ...
    [Migration("20240309165213_MigracionNuevosUusariosAdmin")]
    partial class MigracionNuevosUusariosAdmin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiCine.Modelos.Butaca", b =>
                {
            ...
            modelBuilder.Entity("ApiCine.Modelos.Pelicula", b =>
                {
            ...
            modelBuilder.Entity("ApiCine.Modelos.Reserva", b =>
                {
            ...
            modelBuilder.Entity("ApiCine.Modelos.ReservaButaca", b =>
                {
                    b.Property<int>("ReservaID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiCine.Modelos.Sala", b =>
                {
                    b.Property<int>("SalaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiCine.Modelos.Sesion", b =>
                {
                    b.Property<int>("SesionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiCine.Modelos.Usuario", b =>
                {
                    b.Property<int>("UsuarioID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            UsuarioID = 2,
                            Contrasena = "fc8252c8dc55839967c58b9ad755a59b61b67c13227ddae4bd3f78a38bf394f7",
            ...
            modelBuilder.Entity("ApiCine.Modelos.Butaca", b =>
                {
                    b.HasOne("ApiCine.Modelos.Sala", "Sala")
                        .WithMany("Butacas")
            ...
            modelBuilder.Entity("ApiCine.Modelos.Reserva", b =>
                {
                    b.HasOne("ApiCine.Modelos.Sesion", "Sesion")
                        .WithMany("Reservas")
                        .HasForeignKey("SesionID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApiCine.Modelos.Usuario", "Usuario")
                        .WithMany("Reservas")
            ...
            modelBuilder.Entity("ApiCine.Modelos.ReservaButaca", b =>
                {
                    b.HasOne("ApiCine.Modelos.Butaca", "Butaca")
                        .WithMany("ReservaButacas")
                        .HasForeignKey("ButacaID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApiCine.Modelos.Reserva", "Reserva")
                        .WithMany("ReservaButacas")
            ...
            modelBuilder.Entity("ApiCine.Modelos.Sesion", b =>
                {
                    b.HasOne("ApiCine.Modelos.Pelicula", "Pelicula")
                        .WithMany("Sesiones")
